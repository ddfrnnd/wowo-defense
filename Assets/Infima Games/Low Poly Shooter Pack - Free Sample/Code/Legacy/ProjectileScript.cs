...
public class ProjectileScript : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		// Direct damage to hit enemy
		EnemyHealth directEnemy = collision.gameObject.GetComponentInParent<EnemyHealth>();
		if (directEnemy != null)
		{
			directEnemy.TakeDamage(100);
		}
		...
		foreach (Collider hit in colliders)
		{
			...
			if (enemy != null)
			{
				enemy.TakeDamage(80); // Deals 80 splash damage
			}
