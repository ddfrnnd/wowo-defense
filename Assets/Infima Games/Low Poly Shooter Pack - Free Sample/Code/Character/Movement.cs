...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        protected override  void Update()
        {
            ...
            // Jump check
            if (grounded && (Input.GetKeyDown(KeyCode.Space) || mobileJumpRequested))
            {
        ...
        /// <summary>
        /// Called by mobile UI jump button.
        /// </summary>
        ...
        /// <summary>
        /// Called by mobile controls to trigger a jump when grounded.
        /// </summary>
